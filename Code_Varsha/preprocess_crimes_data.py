...
from utils.consts import CHICAGO_COORDS


from utils.geo import filter_by_geo_coord
...
def main(raw_crimes_data_path, processed_crimes_data_path):
    ...
    crimes_data = filter_by_geo_coord(crimes_data, CHICAGO_COORDS)
    logging.info('#: {}'.format(len(crimes_data)))
...
main(RAW_CRIMES_DATA_PATH, PROCESSED_CRIMES_DATA_PATH)
